...
bool ImGui::TabButtonEx(const char* ico, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    it_nameanim->second *= style.Alpha;
                                                                                                   //ImColor(it_nameanim->second, 0.200f, 0.200f, 0.100f) && ImColor(it_nameanim->second, 0.200f, 0.200f, 0.100f)
    window->DrawList->AddRectFilledMultiColor(bb.Min + ImVec2(0.000f, 0.000f), bb.Max + ImVec2(bb.Min.x - bb.Min.x - 20, bb.Min.y - bb.Min.y), ImColor(0.00f, 0.00f, 0.00f, 0.000f), ImColor(0.00f, 0.00f, 0.00f, 0.000f), ImColor(0.00f, 0.00f, 0.00f, 0.000f), ImColor(0.00f, 0.00f, 0.00f, 0.000f));

    static float gradient_line = 0;

    if (IsItemClicked() || held) gradient_line = 0;

    if (gradient_line <= 190) gradient_line += 0.4f / ImGui::GetIO().Framerate * 80.f;

    if (tab_count == 0 && label == "Aim") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

    if (tab_count == 1 && label == "Misc") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

    if (tab_count == 2 && label == "Visuals") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

    if (tab_count == 3 && label == "Logger") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

    if (tab_count == 4 && label == "Dialog") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));

    if (tab_count == 5 && label == "Settings") window->DrawList->AddRectFilledMultiColor(ImVec2(0.000f + pos.x, 0.000f + pos.y), ImVec2(gradient_line + pos.x, 40 + pos.y), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.100f));
  ...
  //  const int vtx_idx_2 = GetWindowDrawList()->VtxBuffer.Size;
   // ImGui::ShadeVertsLinearColorGradientKeepAlpha(GetWindowDrawList(), vtx_idx_1, vtx_idx_2, bb.Min + ImVec2(20, 0), bb.Max + ImVec2(bb.Min.x - bb.Min.x - 20, 20), ImColor(78, 72, 72), ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f)); // ãðàäèåíò
                                                                                                                                                                                          /*Burasý aradýðým color */
    IMGUI_TEST_ENGINE_ITEM_INFO(id, label, g.LastItemData.StatusFlags);
    return pressed;
}
...
bool ImGui::ButtonEx8(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    static std::map<ImGuiID, button8Anims> anim; // #include <map> on top of this file, where is "imgui.h" located.
    auto it_anim = anim.find(id);
    if (it_anim == anim.end())
    {
    ...
    // Render
    const ImU32 inside_solid_col = ImColor(16, 16, 16, 255);
    const ImU32 inside_solid_redraw_col = ImColor(220, 20, 60, (int)it_anim->second.alpha);
    const ImU32 outside_col[2] = { ImColor(255, 255, 0, 255)/*topright*/, ImColor(accent_color[0], accent_color[1], accent_color[2], 0.000f)/*botleft*/ };  //ImColor(220, 20, 60, 255)
    draw->AddRectFilled(bb.Min, bb.Max, inside_solid_col, 50);
//    draw->AddRectMultiColor(bb.Min, bb.Max, 255, outside_col[0], outside_col[1], 50, 1.75f, 400.f);
    draw->AddRectFilled(bb.Min, bb.Max, inside_solid_redraw_col, 50);
...
// p_visible != NULL && *p_visible == true  : ÝmMenu->show a small close button on the corner of the header, clicking the button will set *p_visible = false
// p_visible != NULL && *p_visible == false : do not ÝmMenu->show the header at all
...
bool ImGui::Renderingsubtab(const char* icon, bool selected)
{
    ...
    float deltatime = 0.5f * ImGui::GetIO().DeltaTime;
    ...
    ImGui::GetForegroundDrawList()->AddRectFilled(ImVec2(bb.Min.x + 24, bb.Max.y - it_fill->second * 5), ImVec2(bb.Min.x + 35, bb.Max.y - 1), ImColor(188, 11, 11, int(255 * it_filled->second)), 3, ImDrawCornerFlags_Top);
...
bool ImGui::Button__(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ImGuiWindow* window = GetCurrentWindow();
    if (window->SkipItems)
        return false;
    ...
    const ImU32 outside_solid_col = ImColor(220, 20, 60, 255);
    const ImU32 inside_hover_col = ImColor(220, 20, 60, (int)it_anim->second.closing_alpha);
    ...
    PushStyleColor(ImGuiCol_Text, ColorConvertFloat4ToU32(ImColor(220, 20, 60, 255 - (int)it_anim->second.label_alpha)));
    if (g.LogEnabled)
        LogSetNextTextDecoration("[", "]");
    RenderTextClipped(bb.Min + style.FramePadding, bb.Max - style.FramePadding, label, NULL, &label_size, style.ButtonTextAlign, &bb);
    PopStyleColor();
...
void ImGui::TabBarCloseTab(ImGuiTabBar* tab_bar, ImGuiTabItem* tab)
{
    ...
    {
        // Actually select before expecting closure attempt (on an UnsavedDocument tab user is expect to e.g. ÝmMenu->show a popup)
        if (tab_bar->VisibleTabId != tab->ID)
