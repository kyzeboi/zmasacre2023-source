...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Basic"))
    {
...

        {
            ...
            ImGui::SameLine(); HelpMarker(
                ...
                "Right-click on the color square to ÝmMenu->show options.\n"
    ...
    if (ImGui::TreeNode("Color/Picker Widgets"))
    {
        ...
        ImGui::Checkbox("With Options Menu", &options_menu); ImGui::SameLine(); HelpMarker("Right-click on the individual color widget to ÝmMenu->show options.");
...
static void ShowDemoWindowPopups()
{
    ...
    if (ImGui::TreeNode("Popups"))
    {
        ...
        // Simple selection popup (if you want to ÝmMenu->show the current selection inside the Button itself,
...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Reorderable, hideable, with headers"))
    {
        ...
        if (ImGui::BeginTable("table1", 3, flags))
        {
            ...
            // (Later we will ÝmMenu->show how TableSetupColumn() has other uses, optional flags, sizing weight etc.)
            ImGui::TableSetupColumn("One");
            ImGui::TableSetupColumn("Two");
            ImGui::TableSetupColumn("Three");
            ImGui::TableHeadersRow();
    ...
    if (ImGui::TreeNode("Padding"))
    {
        ...
        HelpMarker(
            ...
            "In this demo we don't ÝmMenu->show horizontal borders to emphasize how they don't affect default horizontal padding.");
    ...
    {
        // Create a first table just to ÝmMenu->show all the options/flags we want to make visible in our example!
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    // Submit Tab Bar and Tabs
    {
        ...
        if (ImGui::BeginTabBar("##tabs", tab_bar_flags))
        {
            ...
            // [DEBUG] Stress tests
            //if ((ImGui::GetFrameCount() % 30) == 0) docs[1].Open ^= 1;            // [DEBUG] Automatically ÝmMenu->show/hide a tab. Test various interactions e.g. dragging with this on.
