...
public:
	...
	void SendDialogTextResponse(WORD wDialogID, BYTE bButtonID, WORD wListBoxItem, char* szInputResp);
	void SendDialogResponse(WORD wDialogID, BYTE bButtonID, WORD wListBoxItem);
	...
	void PlayerPlaySound(int soundid, float x, float y, float z);
